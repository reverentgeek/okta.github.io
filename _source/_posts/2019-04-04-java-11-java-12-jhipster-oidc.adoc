...
To begin, sign up for a https://developer.okta.com/signup/[forever-free Okta developer account] (or sign in to `https://{yourOktaDomain}` if you already have an account).
...
If you're interested in how I upgraded JHipster's tests to Spring Security 5.1, see link:/blog/2019/04/15/testing-spring-security-oauth-with-junit[Upgrading Spring Security OAuth and JUnit Tests through the 👀 of a Java Hipster].
...
* May 10, 2019: Updated to use JHipster 6.0 GA release and embed screencast. Changes to this post can be viewed in https://github.com/okta/okta.github.io/pull/2869[okta.github.io#2869].
