...
**Hit the nearest restroom before boarding begins**. Airplane bathrooms are too small and may save you from having to use one. I try to book flights in 2-hour segments so that I NEVER have to use the airplane bathroom. At minimum, it will take 15-20 minutes for boarding, another 10-15 for flight safety briefing and taxi to the runway, and 15-20 minutes to get to the altitude before they turn off the seatbelt sign. So if you think you have to go before you’re on the plane - do it, because it will be almost an hour before you get another chance.

## Make Cruise Ship Internet Work for You

Here's one for **cruise ship travel**:

Cruise ships charge a lot for the internet
 They charge for each simultaneously connected device
 If you want to use more than one device and only have one plan, you have to switch between devices
...
Buy one high-priced internet package and connect your mobile phone to it
Use USB tethering to your laptop
Set up internet sharing on your laptop and then connect any number of devices (satellite can be spotty, but it's gotten good enough for Netflix or Hulu)
